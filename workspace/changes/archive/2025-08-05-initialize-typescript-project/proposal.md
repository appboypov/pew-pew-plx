...
## Why
The PLX project needs a proper TypeScript foundation to build the minimal CLI that helps developers set up PLX file structures and keep AI instructions updated.
