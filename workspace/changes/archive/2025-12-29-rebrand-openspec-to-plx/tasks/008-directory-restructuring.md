...
- [x] 8.3 Update `workspace/AGENTS.md`: replace all "OpenSpec" with "PLX", `openspec` with `workspace`, `openspec` commands with `splx`
- [x] 8.4 Rename `workspace/specs/openspec-conventions/` to `workspace/specs/splx-conventions/`
- [x] 8.5 Update `workspace/specs/splx-conventions/spec.md`: replace OpenSpec terminology with PLX
