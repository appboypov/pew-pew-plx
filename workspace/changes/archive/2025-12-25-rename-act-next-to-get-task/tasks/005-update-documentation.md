...
- `.claude/commands/splx/act-next.md` documents slash command
- `README.md` has "Act Next Command" section
- Command examples use `splx act next`

## Should

- `.claude/commands/splx/get-task.md` documents slash command
- `README.md` has "Get Task Command" section
- Command examples use `splx get task`
...
- [x] 5.1 Rename `.claude/commands/splx/act-next.md` to `get-task.md`
...
- [x] 5.6 Update README.md slash command reference to `/splx/get-task`
