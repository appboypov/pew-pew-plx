# Add Init Command for PLX

## Why

Projects need a simple way to adopt PLX conventions. Currently, users must manually create the directory structure and understand all the conventions, which creates friction for adoption. An init command would enable instant PLX setup with proper structure and guidance.
