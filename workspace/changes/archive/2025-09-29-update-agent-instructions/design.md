...
- **`plx list` prominence** - Essential for discovering changes and specs
...
- **Deprecation cleanup** - Remove noun-first patterns (plx change show)
...
- Use `plx list --specs` to discover current capabilities
