...
- **`splx list` prominence** - Essential for discovering changes and specs
...
- **Deprecation cleanup** - Remove noun-first patterns (splx change show)
...
- Use `splx list --specs` to discover current capabilities
