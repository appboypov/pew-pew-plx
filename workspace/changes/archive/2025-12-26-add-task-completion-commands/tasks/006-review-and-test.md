...
- [x] 6.3 Test `splx complete task --id` with valid/invalid IDs
- [x] 6.4 Test `splx complete change --id` with valid/invalid IDs
- [x] 6.5 Test `splx undo task --id` with valid/invalid IDs
- [x] 6.6 Test `splx undo change --id` with valid/invalid IDs
- [x] 6.7 Test `splx get task --id` auto-transition behavior
