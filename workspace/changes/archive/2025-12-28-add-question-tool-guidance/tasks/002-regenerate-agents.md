...
The project's `workspace/AGENTS.md` reflects the updated template with question tool guidance.
...
- [ ] `workspace/AGENTS.md` contains question tool guidance in the "Before Creating Specs" section
- [ ] `workspace/AGENTS.md` contains question tool guidance in the "Error Recovery" section
