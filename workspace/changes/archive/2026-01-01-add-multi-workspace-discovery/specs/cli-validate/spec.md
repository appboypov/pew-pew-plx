...
- **WHEN** executing `splx validate --all --workspace project-a`
...
- **WHEN** executing `splx validate project-a/add-feature`
...
- **WHEN** executing `splx validate --all --json` in multi-workspace mode
