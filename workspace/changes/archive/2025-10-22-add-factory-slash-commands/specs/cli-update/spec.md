...
- **WHEN** `.factory/commands/` contains `splx-proposal.md`, `splx-apply.md`, and `splx-archive.md`
...
- **WHEN** `.github/prompts/` contains `splx-proposal.prompt.md`, `splx-apply.prompt.md`, and `splx-archive.prompt.md`
