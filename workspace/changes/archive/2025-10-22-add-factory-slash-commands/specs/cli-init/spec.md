...
- **THEN** create `.factory/commands/plx-proposal.md`, `.factory/commands/plx-apply.md`, and `.factory/commands/plx-archive.md`
...
- **AND** wrap the generated content in PLX managed markers so `plx update` can safely refresh the commands
