...
- Add `splx paste request` command to save clipboard content to `workspace/drafts/request.md`
...
- Affected docs: `.claude/commands/splx/proposal.md`, `workspace/AGENTS.md`
