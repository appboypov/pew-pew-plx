...
- Graceful degradation when outside PLX projects
...
│       ├── command-registry.ts    # Single source of truth for PLX commands
...
2. **Not in PLX project** - Skip dynamic completions, only offer static commands
...
3. **Manual Testing**
   ...
   - Tab completion behavior in PLX projects
