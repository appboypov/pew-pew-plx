...
## 2. Implementation
- [x] 2.1 Add multi-select support to the `plx init` prompt, including indicators for existing tool configs
...
- [x] 3.2 Perform `plx init` smoke test in a temp directory (document output)
