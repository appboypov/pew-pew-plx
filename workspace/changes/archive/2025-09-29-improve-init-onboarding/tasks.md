...
- [x] 1.2 Update `workspace/specs/cli-init/spec.md` to capture multi-select onboarding requirements

## 2. Implementation
- [x] 2.1 Add multi-select support to the `splx init` prompt, including indicators for existing tool configs
...
- [x] 3.2 Perform `splx init` smoke test in a temp directory (document output)
