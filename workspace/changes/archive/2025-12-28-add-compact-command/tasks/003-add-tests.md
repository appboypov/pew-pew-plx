...
- [x] 3.1 Locate or create test file for splx-slash-command-templates
...
- [x] 3.7 Locate or create test file for splx-base configurator
- [x] 3.8 Add test: ALL_PLX_COMMANDS includes 'compact' (covered by splx-parity.test.ts)
