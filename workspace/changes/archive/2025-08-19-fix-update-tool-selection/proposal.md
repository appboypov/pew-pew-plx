...
3. Always update the core PLX files (README.md, etc.)
...
- **cli-update:** Modify update behavior to update only existing AI tool configuration files and never create new ones; always update core PLX files and display an ASCII-safe success message.
