## 1. CLI wiring
- [x] 1.1 Add Windsurf to the selectable AI tools in `plx init`, including "already configured" detection.
...
- [x] 1.3 Ensure `plx update` pulls the Windsurf configurator when winds is selected and skips creation when files are absent.
...
## 3. Tests & safeguards
- [x] 3.1 Extend init tests to assert creation of `.windsurf/workflows/plx-*.md` when Windsurf is chosen.
