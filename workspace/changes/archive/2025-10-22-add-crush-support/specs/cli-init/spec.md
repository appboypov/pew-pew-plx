...
- **THEN** create `.clinerules/splx-proposal.md`, `.clinerules/splx-apply.md`, and `.clinerules/splx-archive.md`
- **AND** populate each file from shared templates so command text matches other tools
...
- **THEN** create `.crush/commands/workspace/proposal.md`, `.crush/commands/workspace/apply.md`, and `.crush/commands/workspace/archive.md`
- **AND** populate each file from shared templates so command text matches other tools
- **AND** include Crush-specific frontmatter with PLX category and tags
- **AND** each template includes instructions for the relevant PLX workflow stage
