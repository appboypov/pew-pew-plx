## Why
Add support for Crush AI assistant in PLX to enable developers to use Crush's enhanced capabilities for spec-driven development workflows.
...
- New files: .crush/commands/workspace/ (proposal.md, apply.md, archive.md)