...
- [x] 5.1 Update `workspace/AGENTS.md` to reference `splx/plan-request`
- [x] 5.2 Update `workspace/AGENTS.md` to reference `splx/plan-proposal`
...
- [x] 5.6 Run `splx validate --all` to verify documentation consistency
