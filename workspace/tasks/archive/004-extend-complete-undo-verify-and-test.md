...
- [x] 4.4 Manually test `splx complete review --id <test-id>`
- [x] 4.5 Manually test `splx complete spec --id <test-id>`
- [x] 4.6 Manually test `splx undo review --id <test-id>`
- [x] 4.7 Manually test `splx undo spec --id <test-id>`
