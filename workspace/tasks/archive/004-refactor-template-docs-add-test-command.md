...
---
# Task: Add splx/test command

## End Goal

splx/test command runs testing workflow, accepting --change-id, --task-id, --spec-id arguments like review command.
...
- splx/test command reads TESTING.md config
...
- [x] 4.5 Run `splx update` to regenerate all tool configurator files
- [x] 4.6 Verify test command appears in .claude/commands/splx/test.md
