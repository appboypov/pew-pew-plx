...
- [x] 4.1 Update success message to include task archive count
- [x] 4.2 Conditionally display task count (only when > 0)
- [x] 4.3 Update output format for moved tasks
- [x] 4.4 Test output with zero, one, and multiple tasks
