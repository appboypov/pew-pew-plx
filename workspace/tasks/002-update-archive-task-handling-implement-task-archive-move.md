...
- [x] 2.1 Add function to create `workspace/tasks/archive/` directory
- [x] 2.2 Implement file move logic preserving filename
- [x] 2.3 Add duplicate filename detection and suffix logic
- [x] 2.4 Integrate task archive move into archive command flow
- [x] 2.5 Add error handling for filesystem operations
