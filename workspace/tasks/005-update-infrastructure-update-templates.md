...
- [x] 5.1 Update agents-template.ts with new CLI patterns
- [x] 5.2 Update slash-command-templates.ts with new CLI patterns
- [x] 5.3 Update architecture-template.ts with new directory structure
- [x] 5.4 Update review-template.ts with new CLI patterns
- [x] 5.5 Update release-template.ts with new CLI patterns
- [x] 5.6 Update testing-template.ts with new CLI patterns
- [x] 5.7 Create task-template.ts for task entity creation
- [x] 5.8 Create change-template.ts for change proposal scaffolding
- [x] 5.9 Create spec-template.ts for spec scaffolding
- [x] 5.10 Create request-template.ts for request creation
- [x] 5.11 Update index.ts to export new templates
- [x] 5.12 Update TemplateManager with new template accessors
