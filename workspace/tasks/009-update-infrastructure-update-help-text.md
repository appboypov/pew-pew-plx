...
- [x] 9.1 Update src/cli/index.ts program description
- [x] 9.2 Update get command help and subcommands
- [x] 9.3 Add create command help
- [x] 9.4 Update paste command help for new entities
- [x] 9.5 Update validate command help for entity subcommands
- [x] 9.6 Update archive command help for entity subcommands
- [x] 9.7 Update review command help for entity subcommands
- [x] 9.8 Update complete command help for new entities
- [x] 9.9 Update undo command help for new entities
