# PLX Conventions Specification

## Purpose

PLX conventions SHALL define how system capabilities are documented, how changes are proposed and tracked, and how specifications evolve over time. This meta-specification serves as the source of truth for PLX's own conventions.
## Requirements
...
- **WHEN** users run noun-prefixed commands such as `splx spec ...` or `splx change ...`
