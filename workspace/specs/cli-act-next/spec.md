# cli-act-next Specification

## Purpose
TBD - created by archiving change add-prioritized-next-task. Update Purpose after archive.
## Requirements
...
- **WHEN** user runs `splx act next --did-complete-previous`
...
- **WHEN** user runs `splx act next --json`
