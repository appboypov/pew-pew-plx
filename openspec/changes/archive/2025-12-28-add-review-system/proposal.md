...
Reviews live in `openspec/reviews/` alongside changes and specs. Each review has a mandatory parent (change, spec, or task). Reviews have no status field - status is derived from tasks (like changes).
