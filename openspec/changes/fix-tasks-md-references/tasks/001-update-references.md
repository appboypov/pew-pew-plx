...
- [x] 1.1 Update `openspec/AGENTS.md` line 45: `tasks.md` → `tasks/` directory
- [x] 1.2 Update `openspec/AGENTS.md` lines 53, 55: Stage 2 workflow references
- [x] 1.3 Update `openspec/AGENTS.md` line 172: Directory structure diagram
- [x] 1.4 Update `openspec/AGENTS.md` lines 235-242: Task creation example
- [x] 1.5 Update `openspec/AGENTS.md` line 369: Happy path script
- [x] 1.6 Update `openspec/AGENTS.md` line 391: Multi-capability example
- [x] 1.7 Update `openspec/AGENTS.md` line 481: Quick reference
...
- The source template (`agents-template.ts`) generates `AGENTS.md` via `openspec update`
