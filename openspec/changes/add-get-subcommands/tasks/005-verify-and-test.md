...
- [x] 5.4 Manual test: `openspec get task --id <id>`
- [x] 5.5 Manual test: `openspec get task --constraints`
- [x] 5.6 Manual test: `openspec get task --constraints --acceptance-criteria`
- [x] 5.7 Manual test: `openspec get change --id <id>`
- [x] 5.8 Manual test: `openspec get spec --id <id>`
- [x] 5.9 Manual test: `openspec get tasks`
- [x] 5.10 Manual test: `openspec get tasks --id <change-id>`
